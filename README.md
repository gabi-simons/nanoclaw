...
- **Messenger I/O** - Message NanoClaw from your phone. Supports WhatsApp, Telegram, Discord, Slack and headless operation.
...
- **Optional integrations** - Add Gmail (`/add-gmail`) and more via [skills](/.claude/skills)
